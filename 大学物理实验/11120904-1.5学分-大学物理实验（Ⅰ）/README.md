...
作为参考，前述的误差理论测试在 25 级被合并到了期末考试中，学生需要先在线下教室用手机在学习通上完成误差理论测试，完成后上交手机换取操作考核试卷。授课老师会在考前将操作考核试卷发到课程群里，并在考前发布每个人的抽取结果（这就是说，你可以提前对照着试卷复习）。详情请参考附件中的「最后一堂课考试说明和各个实验操作考核要求（25 级）」文件夹。

**请在上课时务必认真对待实验数据**，本人在课程中遇到的老师都会非常认真仔细地核查数据，**任何修改、美化数据或抄袭他人数据（无论是往届的还是同组同学的）的行为都有可能会被老师发现**。
