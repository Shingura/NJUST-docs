...
作为参考，前述的误差理论测试在 25 级被合并到了期末考试中，学生需要先在线下教室用手机在学习同上完成误差理论测试，完成后上交手机换取操作考核试卷。授课老师会在考前将操作考核试卷发到课程群里，并在考前发布每个人的抽取结果（这就是说，你可以提前对照着试卷复习）。详情请参考附件中的「最后一堂课考试说明和各个实验操作考核要求（25 级）」文件夹。
